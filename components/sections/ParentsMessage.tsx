...
const PROS_RIGHT = [
  '+300h de travail compilé en 12 vidéos de 10 minutes',
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0"
            ...
            {/* ══ CARTE GAUCHE — 1h de cours particulier ══ */}
            <motion.div
            ...
            >
              ...
              <div style={{ minHeight: 168, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end' }}>
                <h3 style={{
              ...
              <ul className="flex flex-col gap-2 w-full flex-1">
                {CONS_LEFT.map((txt, i) => (
                  <motion.li key={i}
                    ...
                    whileHover={{ y: -3, background: 'rgba(192,57,43,0.1)', transition: { type: 'spring', stiffness: 280, damping: 30 } }}
                  >
            ...
            >
              ...
              <div style={{ minHeight: 168, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', position: 'relative' }}>
                <h3 style={{
                  ...
                  marginBottom: 'clamp(12px, 1.5vw, 20px)',
                  letterSpacing: '0.1em',
                  textShadow: '0 2px 4px rgba(0,0,0,0.9), 0 4px 12px rgba(0,0,0,0.8), 0 8px 32px rgba(0,0,0,0.6), 0 0 20px rgba(255,226,52,0.6)',
                }}>
                  MATHS ULTIME
                </h3>
              ...
              <ul className="flex flex-col gap-2 w-full flex-1" style={{ position: 'relative' }}>
                {PROS_RIGHT.map((txt, i) => (
                  <motion.li key={i}
                    ...
                    whileHover={{ y: -3, background: 'rgba(255,255,255,0.2)', transition: { type: 'spring', stiffness: 280, damping: 30 } }}
                  >
              ...
              <div className="mt-5 pt-4 w-full flex flex-col items-center gap-2" style={{ borderTop: '2px solid rgba(255,255,255,0.35)', position: 'relative' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, cursor: 'pointer' }}>
                  <GreekCTA
                    href="https://www.bonzai.pro/auth?action=buyPrice%2Cpri_9Z0n_9889"
                    label="ACCÉDER — 47€"
                    size="sm"
                    showBadges={false}
                    goldBorder={false}
