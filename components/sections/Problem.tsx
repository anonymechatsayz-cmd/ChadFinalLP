...
const CARDS = [
  {
    ...
    text: "Tu révises des heures pour l'évale, tu relis tes fiches, tu penses avoir compris… et tu te prends un 10/20. Apprendre par cœur, ça ne suffit pas. Avec Maths Ultime, tu comprends ton cours avant de l'apprendre, et tes notes font ×2.",
    baseRot: -1.5,
    hoverRot: -5,
    accent: '#EC6426',
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p style={{ fontFamily: 'var(--font-baloo)', fontSize: 'clamp(14px, 1.3vw, 17px)', color: 'rgba(26,45,74,0.6)', fontWeight: 500, maxWidth: 480, margin: '0 auto' }}>
          ...
          {CARDS.map((card, i) => (
            ...
            >
              <div style={{
                ...
                <div
                  className="flex justify-center items-center pt-2 pb-1 rounded-lg"
                ...
                <p style={{
                  ...
                  fontSize: 'clamp(15px, 1.4vw, 19px)', color: card.accent,
                ...
                {/* Corps */}
                <p style={{
                  fontFamily: 'var(--font-baloo)', fontSize: 'clamp(13.5px, 1.1vw, 15.5px)',
                  color: 'rgba(30,18,8,0.88)', lineHeight: 1.72, fontWeight: 600, textAlign: 'center',
                }}>
                  {card.text}
                </p>
                {RULE}
