...
export function Timeline() {
  ...
  return (
    <section ref={containerRef} className="relative overflow-x-clip border-t-4 border-[#1a2d4a]" style={{ background: '#d4e8f5' }}>
      ...
      <div className="flex gap-8 lg:gap-12 items-start pb-20">

          {/* ── PANNEAU ILLUSTRATION GAUCHE — sticky, collé au bord ── */}
          <div className="hidden md:block shrink-0 self-start sticky" style={{ width: 240, top: '10vh', paddingLeft: 'clamp(12px, 2vw, 32px)' }}>
            <div>
          ...
          <div className="flex-1 min-w-0 px-4" style={{ maxWidth: 720 }}>
            <div className="relative">
              ...
              {/* Ligne verticale — Layer 2: progression orange animée GSAP */}
              <div ref={progressBarRef} className="absolute top-0 pointer-events-none" style={{
                left: 20, width: 3, borderRadius: 4, height: '0%',
