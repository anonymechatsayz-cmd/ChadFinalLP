  ...
  return (
    <svg viewBox="0 0 220 200" className="w-full h-full max-w-[200px] mx-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.g initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.6, duration: 0.5 }}>
        <text x="68" y="79" textAnchor="middle" fill="#1a2d4a" fontSize="20" fontStyle="italic" className="font-cinzel font-bold">a²</text>
        <text x="153" y="79" textAnchor="middle" fill="#d4a017" fontSize="16" fontStyle="italic" className="font-cinzel">ab</text>
        <text x="68" y="158" textAnchor="middle" fill="#d4a017" fontSize="16" fontStyle="italic" className="font-cinzel">ab</text>
        <text x="153" y="158" textAnchor="middle" fill="#1a2d4a" fontSize="20" fontStyle="italic" className="font-cinzel font-bold">b²</text>
      </motion.g>
      <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8, duration: 0.5 }}>
        <text x="70" y="14" textAnchor="middle" fill="#1a2d4a" fontSize="12" fontStyle="italic" className="font-cinzel">a</text>
        <text x="152" y="14" textAnchor="middle" fill="#1a2d4a" fontSize="12" fontStyle="italic" className="font-cinzel">b</text>
        <text x="10" y="74" textAnchor="middle" fill="#1a2d4a" fontSize="12" fontStyle="italic" className="font-cinzel">a</text>
        <text x="10" y="157" textAnchor="middle" fill="#1a2d4a" fontSize="12" fontStyle="italic" className="font-cinzel">b</text>
        <text x="110" y="197" textAnchor="middle" fill="#d4a017" fontSize="12" fontStyle="italic" className="font-cinzel font-bold">(a+b)² = a² + 2ab + b²</text>
      </motion.g>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 220 200" className="w-full h-full max-w-[200px] mx-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.g initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 0.5 }}>
        <text x="110" y="13" textAnchor="middle" fill="#1a2d4a" fontSize="14" fontStyle="italic" className="font-cinzel font-bold">A</text>
        <text x="22" y="178" textAnchor="middle" fill="#1a2d4a" fontSize="14" fontStyle="italic" className="font-cinzel font-bold">B</text>
        <text x="198" y="178" textAnchor="middle" fill="#1a2d4a" fontSize="14" fontStyle="italic" className="font-cinzel font-bold">C</text>
        <text x="95" y="100" textAnchor="middle" fill="#d4a017" fontSize="12" fontStyle="italic" className="font-cinzel">h</text>
      </motion.g>
      <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8, duration: 0.5 }}>
        <line x1="68" y1="100" x2="78" y2="96" stroke="#1a2d4a" strokeWidth="1.5" />
        <line x1="148" y1="100" x2="158" y2="96" stroke="#1a2d4a" strokeWidth="1.5" />
        <text x="110" y="197" textAnchor="middle" fill="#d4a017" fontSize="12" fontStyle="italic" className="font-cinzel font-bold">Aire = ½ × BC × h</text>
      </motion.g>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 220 210" className="w-full h-full max-w-[200px] mx-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8, duration: 0.5 }}>
        ...
        <text x="100" y="50" textAnchor="middle" fill="#1a2d4a" fontSize="13" fontStyle="italic" className="font-cinzel font-bold">A</text>
        <text x="100" y="170" textAnchor="middle" fill="#1a2d4a" fontSize="13" fontStyle="italic" className="font-cinzel font-bold">Ā</text>
        <text x="58" y="72" fill="#d4a017" fontSize="11" fontStyle="italic" className="font-cinzel">0,6</text>
        <text x="55" y="140" fill="#d4a017" fontSize="11" fontStyle="italic" className="font-cinzel">0,4</text>
        <text x="136" y="36" fill="#1a2d4a" fontSize="10" fontStyle="italic" className="font-cinzel">B|A  0,7</text>
        <text x="132" y="83" fill="#1a2d4a" fontSize="10" fontStyle="italic" className="font-cinzel">B̄|A  0,3</text>
        <text x="130" y="118" fill="#1a2d4a" fontSize="10" fontStyle="italic" className="font-cinzel">B|Ā  0,5</text>
        <text x="130" y="175" fill="#1a2d4a" fontSize="10" fontStyle="italic" className="font-cinzel">B̄|Ā  0,5</text>
        <text x="110" y="204" textAnchor="middle" fill="#d4a017" fontSize="12" fontStyle="italic" className="font-cinzel font-bold">Arbre de probabilités</text>
      </motion.g>
    </svg>
  );
}
...
function IlluFormat() {
  return (
    <svg viewBox="0 0 220 200" className="w-full h-full max-w-[200px] mx-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
      <motion.rect custom={0} variants={draw} initial="hidden" animate="visible" x="25" y="35" width="150" height="100" rx="6" stroke="#1a2d4a" strokeWidth="2.5" />
      <motion.rect custom={1} variants={draw} initial="hidden" animate="visible" x="25" y="125" width="150" height="8" rx="2" stroke="#1a2d4a" strokeWidth="2" fill="rgba(26,45,74,0.08)" />
      <motion.line custom={2} variants={draw} initial="hidden" animate="visible" x1="75" y1="133" x2="145" y2="133" stroke="#1a2d4a" strokeWidth="2.5" strokeLinecap="round" />
      <motion.rect custom={3} variants={draw} initial="hidden" animate="visible" x="168" y="100" width="30" height="52" rx="5" stroke="#d4a017" strokeWidth="2" />
      <motion.line custom={4} variants={draw} initial="hidden" animate="visible" x1="168" y1="112" x2="198" y2="112" stroke="#d4a017" strokeWidth="1.5" />
      <motion.line custom={5} variants={draw} initial="hidden" animate="visible" x1="168" y1="143" x2="198" y2="143" stroke="#d4a017" strokeWidth="1.5" />
      <motion.rect custom={6} variants={draw} initial="hidden" animate="visible" x="5" y="110" width="25" height="38" rx="2" stroke="#1a2d4a" strokeWidth="1.5" />
      <motion.g initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.8, type: "spring" }}>
        <text x="100" y="98" textAnchor="middle" fill="#d4a017" fontSize="36" className="font-cinzel">★</text>
      ...
      <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1, duration: 0.5 }}>
        ...
        <text x="110" y="168" textAnchor="middle" fill="#d4a017" fontSize="12" fontStyle="italic" className="font-cinzel font-bold">Tous supports · Accès à vie</text>
      </motion.g>
    </svg>
  );
}
    ...
    <section ref={containerRef} className="relative border-t-4 border-[#1a2d4a] bg-[#d4e8f5]">
      ...
      <div className="relative z-10 text-center pt-20 pb-16 px-6">
        ...
        <motion.p 
          ...
          className="font-space text-[clamp(14px,1.3vw,17px)] text-[#1a2d4a]/75 mt-3 font-medium"
        >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 pb-28">
        <div className="flex gap-8 lg:gap-16">
          ...
          <div className="hidden md:block shrink-0 w-[280px]">
          ...
          <div ref={timelineRef} className="flex-1 min-w-0 relative">
            ...
            <div className="flex flex-col gap-12 pb-8">
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.h3 
                        ...
                        className="font-cinzel font-extrabold text-[clamp(20px,2.2vw,26px)] text-[#1a2d4a] mb-2.5 leading-[1.2] relative z-10"
                      >
                        {mod.title}
                      </motion.h3>
                      <motion.p 
                        ...
                        className="font-space text-[clamp(14px,1.2vw,15px)] text-[#1a2d4a]/75 leading-[1.65] font-normal relative z-10"
                      >
                        {mod.desc}
                      </motion.p>
                    </motion.div>
              ...
              {/* CTA FINAL (Le Climax) */}
              <motion.div 
                className="flex items-center gap-6 lg:gap-8 relative mt-6"
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                onViewportEnter={() => setIsUnlocked(true)}
                viewport={{ margin: "0px 0px -15% 0px", amount: 0.3, once: true }}
              ...
              >
                 ...
                 <div className="flex-1 rounded-xl flex flex-col items-center text-center bg-white relative overflow-hidden border-[3px] border-[#1a2d4a] shadow-[6px_6px_0_#1a2d4a] py-8 px-6 sm:px-10">
                     <div className="relative z-10 flex flex-col items-center w-full">
                         ...
                         <div className="flex gap-1.5 justify-center relative z-10 mb-2">
                           {[...Array(5)].map((_, i) => (
                             <Star key={i} className="w-4 h-4 fill-[#d4a017] text-[#d4a017]" />
                           ))}
                         </div>
                         <p className="font-montserrat text-[10px] sm:text-[11px] text-[#1a2d4a]/40 tracking-[0.1em] uppercase font-bold relative">
