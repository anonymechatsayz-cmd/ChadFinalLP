  ...
  return (
    <div className={`flex flex-col items-center gap-3 w-full max-w-[min(100%,480px)] ${className}`}>
      <motion.a
        ...
        whileHover={{ y: 2, boxShadow: `4px 4px 0 ${shadowCol}, 0 6px 20px rgba(236,100,38,0.25), inset 0 2px 0 rgba(255,255,255,0.2)`, transition: { duration: 0.06 } }}
          ...
          <div key={i} className="flex gap-10 items-center">
            {reviews.map((review, j) => (
              <div key={j} className="flex gap-10 items-center">
                <span style={{ fontFamily: 'var(--font-baloo)', fontWeight: 700, fontSize: 14, color: 'rgba(245,236,212,0.8)' }}>{review}</span>
