...
const SKY_SYMS = [
  { s:'∫',  top: 5,  left:  4, sz:19, op:0.28, d:7.2, dy: 9, rot: -22, c:'#d4b86a' },
  { s:'√',  top:14,  left: 11, sz:13, op:0.22, d:9.1, dy: 6, rot:  15, c:'#8ab4d8' },
  { s:'∞',  top: 3,  left: 26, sz:15, op:0.25, d:8.6, dy:10, rot:   8, c:'#d4b86a' },
  { s:'φ',  top:10,  left: 38, sz:11, op:0.20, d:7.9, dy: 5, rot: -34, c:'#8ab4d8' },
  { s:'≈',  top: 2,  left: 52, sz:12, op:0.18, d:9.4, dy: 7, rot:  27, c:'#d4b86a' },
  { s:'∂',  top:17,  left: 44, sz:16, op:0.24, d:6.8, dy: 8, rot: -12, c:'#8ab4d8' },
  { s:'Δ',  top: 7,  left: 61, sz:14, op:0.22, d:8.2, dy: 9, rot:  41, c:'#d4b86a' },
  { s:'θ',  top:13,  left: 70, sz:18, op:0.26, d:7.5, dy:11, rot: -18, c:'#8ab4d8' },
  { s:'λ',  top: 4,  left: 79, sz:12, op:0.20, d:9.7, dy: 6, rot:  29, c:'#d4b86a' },
  { s:'ψ',  top:18,  left: 87, sz:15, op:0.23, d:6.4, dy: 8, rot: -45, c:'#8ab4d8' },
  { s:'∇',  top: 8,  left: 93, sz:13, op:0.21, d:8.9, dy: 7, rot:  16, c:'#d4b86a' },
  { s:'α',  top:16,  left: 22, sz:11, op:0.19, d:7.1, dy: 5, rot: -28, c:'#8ab4d8' },
  { s:'ω',  top: 6,  left: 96, sz:17, op:0.24, d:9.3, dy:10, rot:  33, c:'#d4b86a' },
  { s:'γ',  top:12,  left: 57, sz:12, op:0.20, d:8.0, dy: 6, rot: -52, c:'#8ab4d8' },
  { s:'ε',  top: 1,  left: 86, sz:10, op:0.17, d:7.6, dy: 5, rot:  20, c:'#d4b86a' },
  { s:'σ',  top:19,  left:  2, sz:14, op:0.22, d:9.8, dy: 7, rot: -37, c:'#8ab4d8' },
  { s:'μ',  top: 9,  left: 17, sz:11, op:0.18, d:8.5, dy: 6, rot:  44, c:'#d4b86a' },
  { s:'Ω',  top:15,  left: 33, sz:13, op:0.21, d:7.3, dy: 8, rot: -14, c:'#8ab4d8' },
];
