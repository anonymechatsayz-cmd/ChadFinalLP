      ...
      <div className="mx-auto max-w-2xl px-5 py-14">
        ...
        <Section title="Éditeur du site">
          ...
          <ul className="list-none space-y-1 mb-3" style={{ paddingLeft: 16 }}>
            ...
            <li>• <strong>SIREN :</strong> 939 007 373</li>
            <li>• <strong>SIRET :</strong> 93900737300011</li>
            <li>• <strong>TVA :</strong> Non assujettie à la TVA (régime micro-entreprise)</li>
            <li>• <strong>Siège social :</strong> 327 Route de la Vallée, 49150 Baugé-en-Anjou – France</li>
            <li>• <strong>Adresse email de contact :</strong> <a href="mailto:chadsciences@maths-ultime.fr" style={{ color: '#EC6426' }}>chadsciences@maths-ultime.fr</a></li>
          </ul>
        </Section>
